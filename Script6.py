...
while inseridos < quantos_users and tentativas < max_tentativas:
    ...
    try:
        cursor.execute("INSERT INTO users (name, address, password) VALUES (?, ?, ?)", (nome_completo, morada, password))
        inseridos += 1
        print(f"Inserido: {nome_completo}")
